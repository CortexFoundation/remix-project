...
class SettingsUI {
    ...
    render() {
      ...
      <div class="${css.crow}">
        ...
        <div class="${css.environment}">
          ...
          <a href="https://www.cortexlabs.ai/#top" target="_blank"><i class="${css.infoDeployAction} ml-2 fas fa-info" title="check out docs to setup Environment"></i></a>
        </div>
      </div>
    `
        const networkEl = yo `
    ...
    web3ProviderDialogBody() {
        ...
        return yo `
      <div class="">
        Note: To use CortexTheseus & https://cerebro.cortexlabs.ai/remix/, configure it to allow requests from Remix:(see <a href="https://www.cortexlabs.ai/#top" target="_blank">Geth Docs on rpc server</a>)
        <div class="border p-1">geth --http --http.corsdomain https://www.cortexlabs.ai/#top</div>
        <br>
        To run Remix & a local CortexTheseus test node, use this command: (see <a href="https://www.cortexlabs.ai/#top" target="_blank">CortexTheseus Docs on Dev mode</a>)
        ...
        <br>
        <br>For more info: <a href="https://www.cortexlabs.ai/#top" target="_blank">Remix Docs on Web3 Provider</a>
        <br>
        <br> 
