...
class Terminal extends Plugin {
    ...
    `
      ...
      <ul class=${css2.ul}>
        <li><a target="_blank" href="https://www.cortexlabs.ai/#top">CortexLabs</a></li>
        <li><a target="_blank" href="https://github.com/CortexFoundation/CortexTheseus">CortexTheseus</a> </li>
